...
Usage:
    from app.components.retrieval.vector_store import ChromaDBVectorStore, get_vector_store
...
def get_vector_store() -> RetrievalStore:
    ...
    if backend == "qdrant":
        from app.components.retrieval.qdrant_store import QdrantVectorStore
