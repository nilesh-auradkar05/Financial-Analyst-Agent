...
eval-single:
	uv run python -m evaluation.retrieval_main evaluation/fixtures/retrieval_baseline.json --case appl_risk_supply_chain

eval-full:
	@echo "Run evaluation/run_rag_quality_eval.py with --judge-model after configuring judge credentials."

eval-report:
	@echo "Retrieval comparison reports are generated by evaluation/run_retrieval_method_matrix.py"

eval-retrieval:
	uv run python -m evaluation.retrieval_main evaluation/fixtures/retrieval_baseline.json
